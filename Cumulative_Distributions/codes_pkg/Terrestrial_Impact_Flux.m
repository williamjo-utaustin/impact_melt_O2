...
F_total_1km = F_total * scaling_factor_1km;
...
figure
semilogy(t, F_total_1km, 'Color', 'black', 'LineWidth', 4);
hold on
semilogy(t, F_ast_1km, 'Color', 'magenta', 'LineWidth', 2, 'LineStyle','-')
hold on
semilogy(t, F_com_1km, 'Color', 'cyan', 'LineWidth', 2, 'LineStyle','-')
hold on
%semilogy(t, F_ast_1km + F_com_1km, 'Color', 'red', 'LineWidth', 3)
%hold on
semilogy(t, F_leftover_1km, 'Color', 'green', 'LineWidth', 3)
hold on
xlim([2,4])
grid on

if print_to_file == true
    writematrix(count_asteroids_1km_per_mya(2000:4499), "data_files/asteroid_01km_count_per_mya_20_45.csv")
    writematrix(count_comets_1km_per_mya(2000:4499), "data_files/comet_01km_count_per_mya_20_45.csv")
    writematrix(count_leftovers_1km_per_mya(2000:4499), "data_files/leftover_01km_count_per_mya_20_45.csv")
    
    writematrix(count_asteroids_10km_per_mya(2000:4499), "data_files/asteroid_10km_count_per_mya_20_45.csv")
    writematrix(count_comets_10km_per_mya(2000:4499), "data_files/comet_10km_count_per_mya_20_45.csv")
    writematrix(count_leftovers_10km_per_mya(2000:4499), "data_files/leftover_10km_count_per_mya_20_45.csv")
